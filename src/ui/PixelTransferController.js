  ...
  async requestFromQueue() {
    ...
    try {
      ...
      store.dispatch(pAlert(
        ...
        t`Didn't get an answer from pixuniverse. Try to refresh if this problem persists.`,
        'error',
      ));
    }
    ...
    switch (retCode) {
      ...
      case 16:
        ...
        // eslint-disable-next-line max-len
        msg = t`Didn't get an answer from pixuniverse. Try to refresh if this problem persists.`;
        break;
      case 17:
