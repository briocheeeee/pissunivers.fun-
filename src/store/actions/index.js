...
export function toggleChatFlag() {
  return {
    type: 's/TGL_CHAT_FLAG',
  };
}

export function toggleChatAvatar() {
  return {
    type: 's/TGL_CHAT_AVATAR',
  };
}
...
export function selectBrushSize(brushSize) {
  return {
    type: 's/SELECT_BRUSH_SIZE',
    brushSize,
  };
}
...
export function setCoolDownModifiers(modifiers) {
  return {
    type: 'COOLDOWN_MODIFIERS_SET',
    modifiers,
  };
}
