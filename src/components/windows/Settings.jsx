  ...
  return (
    <div className="content">
      ...
      <SettingsItemSelect
        ...
        onSelect={(size) => dispatch(selectBrushSize(parseInt(size, 10)))}
      >
        {t`Set the brush size`}
      </SettingsItemSelect>
      <SettingsItemSelect
        title={t`Theme`}
        values={Object.keys(window.ssv?.availableStyles || { default: true })}
        selected={selectedStyle}
        onSelect={(style) => dispatch(selectStyle(style))}
      >
        {t`How pixuniverse should look like.`}
      </SettingsItemSelect>
