...
const Help = () => {
  ...
  const guildedLink = <a href="/guilded">discord server</a>;
  ...
  return (
    <div className="content">
      ...
      <p className="modalinfo">Discord ({t`recommended`}): <a href="./guilded" target="_blank" rel="noopener noreferrer">{t`Invited to Chat`}</a></p>
      <p className="modalinfo">{t`Source for pixuniverse on `}<a href="https://git.pixunivers.fun" target="_blank" rel="noopener noreferrer">git.pixunivers.fun</a> or <a href={sourceUrl} target="_blank" rel="noopener noreferrer">download here</a>.</p>
      ...
      <h3>{t`Map Data`}</h3>
      <p>{t`The bare map data that we use, together with converted OpenStreetMap tiles for orientation, can be downloaded from mega.nz here: `}<a href="https://mega.nz/#!JpkBwAbJ!EnSLlZmKv3kEBE0HDhakTgAZZycD3ELjduajJxPGaXo">pixuniversemap.zip</a> (422MB)</p>
      ...
      <p>{t`You can connect to pixuniverse and use pixuniverse accounts for oauth / oidc login. See here:`}<a href={u`/oidc/register`}>{t`OpenID Connect Client registration`}</a></p>
