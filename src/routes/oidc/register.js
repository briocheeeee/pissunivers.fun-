...
<p style="font-size: 16px;">${t`Pixuniverse fulfills the OpenID Connect (OIDC) specifications. So an application that supports OIDC could ask for consent and login using pixuniverse accounts. The required endpoints can be auto-discovered via the ${wellKnownUrl} URL.`}</p>
