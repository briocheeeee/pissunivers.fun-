...
import './core/FactionRanks.js';
import './core/TOTWCron.js';
...
import {
  PORT, HOST, HOURLY_EVENT, FISHING, BASENAME, USE_XREALIP,
} from './core/config.js';
...
syncSql()
  ...
  .then(async () => {
    ...
    import('./core/canvases.js').then((m) => initDiscordBot(m.default));
  });
