...
The easiest way to help translate the game is with weblate. Simply use [hosted.weblate.org/projects/pixuniverse](https://hosted.weblate.org/projects/pixuniverse/). Feel free to ask in the Translation section in [our Discord](https://pixunivers.fun/guilded) if you need help.

Tips for Weblate:

- `Ctrl + Enter` is the shortcut for `Save and Continue` while translating
...
[![Translation status](https://hosted.weblate.org/widget/pixuniverse/multi-auto.svg)](https://hosted.weblate.org/engage/pixuniverse/)

# Translating Offline

Two translation files for each language are needed, `ssr-[locale].po` and `[locale].pb` (i.e. `ssr-de.po` and `de.po`).

Translation files can be created out of the templates [template.pot](https://git.pixunivers.fun/pxu/translations/raw/branch/master/template.pot) and [template-ssr.pot](https://git.pixunivers.fun/pxu/translations/raw/branch/master/template-ssr.pot). They are standard GNU gettext files and can be edited in any ordinary texteditor or po-Editor.

## With poedit

### Create new translation

1. Download poedit [here](https://poedit.net/) and [template.pot](https://git.pixunivers.fun/pxu/translations/raw/branch/master/template.pot)
...
6. Do the same again, but with [template-ssr.pot](https://git.pixunivers.fun/pxu/translations/raw/branch/master/template-ssr.pot) and save it as `ssr-[locale].po`
7. Send us the two files on [discord](https://pixunivers.fun/guilded) or make a pull request
